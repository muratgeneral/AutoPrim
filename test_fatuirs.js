...
async function run() {
  ...
  let r = await p.request().query("SELECT TOP 1 FATIRS_NO, BRUTTUTAR, NETTUTAR, GENELTOPLAM, KDV FROM TBLFATUIRS WHERE FTIRSIP='1' AND SUBE_KODU=6 ORDER BY TARIH DESC");
